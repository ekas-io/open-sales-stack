...
1. **Cut filler phrases.** Remove throat-clearing openers and emphasis crutches. See the "Phrases to Remove" section below.
2. **Break formulaic structures.** Avoid binary contrasts, dramatic fragmentation, rhetorical setups. See the "Structures to Avoid" section below.
